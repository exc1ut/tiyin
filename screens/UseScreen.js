...
class UseScreen extends React.Component {
	...
	load = () => {
		fetch(`https://tiyin.uz/news/api/getRules?lang=` + this.props.lang).then((res) => res.json()).then((json) => {
			this.setState({
				...
				<View>
					{this.state.loaded == true ? (
						<View style={styles.container}>
							<Text style={styles.text}>Saytdan foydalanish shartlari</Text>
							<HTML
...
export default withNavigation(connect(mapStateToProps)(UseScreen));
