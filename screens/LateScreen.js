...
class LateScreen extends React.Component { 
    ...
    load = () => {
        fetch(`https://tiyin.uz/news/api/getnewsnocat?limit=20&offset=1&language=`+this.props.lang).then(res => res.json()).then(json => {
...
export default withNavigation(connect(mapStateToProps)(LateScreen))